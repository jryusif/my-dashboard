...
export const SHARIAH_CONFIG = {
  ...
  // Geographic / Jurisdiction Exclusion Policy
  excludedJurisdictions: [
    {
      code: 'IL',
      country: 'Israel',
      reason: 'Company is incorporated, headquartered, or domiciled in Israel (Jurisdiction Exclusion)'
    }
  ],
...
export const KNOWN_ISRAEL_TICKERS = new Set([
  'CHKP', 'CYBR', 'WIX', 'MNDY', 'TEVA', 'NICE', 'SEDG', 'FVRR', 'GLBE', 'INMD',
  'MOB', 'WNDW', 'LPSN', 'NVMI', 'CAMT', 'RDWR', 'AUDC', 'ALLT', 'TSEM', 'SSYS',
  'PERI', 'MTLS', 'PAYO', 'SIMO', 'TARO', 'PLTX', 'ICL', 'ESLT', 'CYRN', 'MNDO',
  'SILC', 'MGIC', 'BWAY', 'ORMP', 'SPNS', 'CRNT', 'GAMIDA', 'ENLV', 'ELRN'
]);
