...
export const SHARIAH_CONFIG = {
  ...
  // Prohibited Business Activities & Sectors (Deterministic Screening)
  prohibitedActivities: [
    {
      code: 'CONV_BANKING',
      name: 'Conventional Banking & Financial Services',
      keywords: ['bank', 'banks', 'banking', 'commercial bank', 'national commercial bank', 'investment banking', 'consumer lending', 'credit services', 'mortgage', 'usury', 'depository'],
      sectors: ['Financials', 'Banking', 'Banks', 'Consumer Finance', 'Diversified Financial Services']
    },
    {
      code: 'CONV_INSURANCE',
      name: 'Conventional Insurance & Reinsurance',
      keywords: ['life insurance', 'property insurance', 'casualty insurance', 'reinsurance'],
      sectors: ['Insurance']
    },
    {
      code: 'ALCOHOL',
      name: 'Alcohol Production & Distribution',
      keywords: ['alcoholic beverages', 'brewery', 'distillery', 'wine', 'beer', 'liquor'],
      sectors: ['Beverages - Brewers', 'Beverages - Wineries & Distilleries']
    },
    {
      code: 'GAMBLING',
      name: 'Gambling & Casinos',
      keywords: ['casino', 'gambling', 'sports betting', 'lottery', 'wagering'],
      sectors: ['Casinos & Gaming']
    },
    {
      code: 'TOBACCO',
      name: 'Tobacco & Cannabis (Recreational)',
      keywords: ['tobacco', 'cigarettes', 'cigars', 'vaping'],
      sectors: ['Tobacco']
    },
    {
      code: 'ADULT_ENT',
    ...
    },
    {
      ...
      keywords: ['firearms manufacturer', 'cluster munitions', 'nuclear weapons', 'weapons systems'],
      sectors: ['Aerospace & Defense - Weapons']
    },
    {
      code: 'PORK',
      name: 'Pork Production & Processing',
      keywords: ['pork processing', 'swine'],
      sectors: ['Meat Products - Pork']
    }
  ],
