...
/**
 * Universal Currency Conversion using live cached FX rates
 */
export function convertCurrency(amount, fromCurr = 'USD', toCurr = 'USD', customRates = null) {
